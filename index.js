...
function addGamesToPage(games) {
    ...
    for (let i=0; i < games.length; i++){
        ...
        <h3>${games[i].name}</h3> <p>${games[i].description}</p> <p>Backers: ${games[i].backers}</p>`;
...
const displayStr = `A total of ${numUnfundedGames} ${numUnfundedGames === 1 ? "game remains" : "games remain"} unfunded. We need your help to fund these amazing games!`;
